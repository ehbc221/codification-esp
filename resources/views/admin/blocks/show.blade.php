                            ...
                            <div class="col-md-8 col-md-offset-2 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-10">
                                        <div class="form-control">{{ $block->name }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-3 col-sm-12">
                            <div class="col-md-2 col-sm-2">
                                <a href="{{ route('admin.batiments.edit', ['id' => $block->id]) }}"><span class="btn btn-primary" id="button-edit" data-toggle="tooltip" data-placement="top" title="Modifier"><i class="fa fa-pencil"></i> Modifier</span></a>
                            </div>
