            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        {!! Form::model($department, ['route' => ['admin.departements.update', $department->id], 'method' => 'put', 'class' => 'form-horizontal']) !!}
                        {!! Form::token() !!}
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-sm-12">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <a href="{{ route('admin.departements.show', ['id' => $department->id]) }}"><span class="btn btn-default" id="button-show" data-toggle="tooltip" data-placement="top" title="Détails"><i class="fa fa-eye"></i> Détails</span></a>
                            </div>
